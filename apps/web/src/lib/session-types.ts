export type InternalRole = "member" | "ta" | "lab_manager" | "admin";
...
export const roleHome: Record<Role, string> = { member: "/workspace/my-requests", ta: "/ta/queue", lab_manager: "/manager/approvals", unassigned: "/pending", admin: "/admin" };
